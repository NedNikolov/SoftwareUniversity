...
def solution(line_1_distance, line_2_distance):
...
line_one_distance = get_distance(x_1, y_1, x_2, y_2)
line_two_distance = get_distance(x_3, y_3, x_4, y_4)
solution(line_one_distance, line_two_distance)
